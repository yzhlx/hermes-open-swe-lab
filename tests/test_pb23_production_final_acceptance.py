...
class PB23FinalAcceptanceTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        # Pin the human-owner token so the comparison is deterministic.
        constants.HUMAN_OWNER_TOKEN = HUMAN_OWNER_TOKEN
    ...
    # -- regression: legacy (non-pipeline) completion still works ----------
